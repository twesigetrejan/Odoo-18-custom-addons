# investments_module/models/account_move_line.py
...
class AccountMoveLine(models.Model):
    ...
    def _check_investments_account_requirements(self):
        ...
        for line in self:
            ...
            if line.account_id.requires_member and line.account_id.account_product_type == 'investments':
