...
class withdrawal_request_reject(models.TransientModel):
    _name = "sacco.investments.withdrawal.request.reject"
    ...
    def action_reject_withdrawal_request(self):
        ...
        withdrawal_request_ids = self.env['sacco.investments.withdrawal.request'].browse(active_ids)
        ...
        for withdrawal_request in withdrawal_request_ids:
            ...
            template_id = ir_model_data._xmlid_lookup('investments_management.withdrawal_request_reject_email')[1]
