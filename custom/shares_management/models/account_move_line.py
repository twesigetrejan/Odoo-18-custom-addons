# shares_management/models/account_move_line.py
...
class AccountMoveLine(models.Model):
    ...
    def _check_shares_account_requirements(self):
        ...
        for line in self:
            ...
            if line.account_id.requires_member and line.account_id.account_product_type == 'shares':
