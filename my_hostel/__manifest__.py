{
    ...
    'data': [
        ...
        'views/loan_portfolio2.xml',
        'views/saving_view.xml',
        'reports/loan_portfolio_report.xml',
        'reports/loan_portfolio2_report_template.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'my_hostel/static/src/js/loan_portfolio2_dashboard.js',
            'my_hostel/static/src/xml/loan_dashboard_main.xml',
            'my_hostel/static/src/xml/loan_portfolio2_dashboard_template.xml',
